...
// Verifica se foi enviado um valor para levantar
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['valor'])) {
    $valor = $_POST['valor'];

    // Validação: o valor não pode ser maior que o saldo disponível
    ...
    $userSaldo = $resultSaldo->fetch_assoc()['Saldo'];

    if ($valor > 0 && $valor <= $userSaldo) {
    ...
    <div class="content">
        ...
        <div class="form-container">
            ...
            <form method="POST">
                ...
                <button type="submit">Levantar Saldo</button>
                <a href="perfil.php">
